...
| COR-03 | **AI Story Creation** | Interface for creating and editing AI-generated stories. Follows 5-screen flow: choose template → pick characters → preview → edit → publish. # TODO add asset WIREFRAME_STORY_CREATION showing the user flow diagram | P0       |
...
| COR-09 | **French Voices**      | 5 native French voice packs covering Parisian, Northern, Southern, Swiss, and Canadian French accents. Parisian and Southern ship at MVP, others post-launch. | P0       |
...
| COR-15 | **Parental Gate & Consent** | Comprehensive parental controls including: reversible age gate, audit log of consent, "Ask a grown-up" CTA copy, biometric fallback on iOS | P0 |
| SHARE-01 | **Web Player Sharing** | One-click web player link with story cover art to pull new users. Creates viral in-product loop beyond referrals. | P1 |

### Non-Functional Requirements

| Ref    | Requirement                | Description                                                                        | Priority |
|--------| -------------------------- | ---------------------------------------------------------------------------------- | -------- |
| A11y-01 | **Accessibility Standards** | Compliance with WCAG guidelines, minimum font size (16px), touch target size (44px), prefers-reduced-motion support, voice prompts, and captioning for hearing-impaired kids. Accommodates variable reading ability and fine-motor control of 6-8y users. | P0 |
| MOD-01 | **Moderation Policy & Escalation** | Human review queue, parental report button, and 24h SLA for content moderation. Complies with EU Digital Services Act and App-Store Kids rules for documented escalation and human appeal process. | P0 |
| OFF-01 | **Offline Capabilities** | Critical assets cached via service workers; offline recording allowed with IndexedDB buffer; sync retries & progress UI. Ensures PWA functionality in cars, rural areas, and other offline scenarios. | P0 |
